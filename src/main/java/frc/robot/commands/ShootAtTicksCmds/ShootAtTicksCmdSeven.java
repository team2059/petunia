...
public class ShootAtTicksCmdSeven extends CommandBase {
  private static ShooterSubsystem shooterSubsystem;
  private static double primaryTicks;
  private static double secondaryTicks;

  /** Creates a new PIDShootCmd. */
  public ShootAtTicksCmdSeven(ShooterSubsystem shooterSubsystem, double primaryTicks, double secondaryTicks) {
