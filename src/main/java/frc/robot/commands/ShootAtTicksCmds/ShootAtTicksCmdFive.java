...
public class ShootAtTicksCmdFive extends CommandBase {
  private static ShooterSubsystem shooterSubsystem;
  private static double primaryTicks;
  private static double secondaryTicks;

  /** Creates a new PIDShootCmd. */
  public ShootAtTicksCmdFive(ShooterSubsystem shooterSubsystem, double primaryTicks, double secondaryTicks) {
