...
public class ShootAtTicksCmdEight extends CommandBase {
  private static ShooterSubsystem shooterSubsystem;
  private static double primaryTicks;
  private static double secondaryTicks;

  /** Creates a new PIDShootCmd. */
  public ShootAtTicksCmdEight(ShooterSubsystem shooterSubsystem, double primaryTicks, double secondaryTicks) {
  ...
  @Override
  public void execute() {
    shooterSubsystem.oppositeFlywheel.set(ControlMode.Velocity, secondaryTicks);
